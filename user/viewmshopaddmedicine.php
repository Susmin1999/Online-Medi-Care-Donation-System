...
<html lang="en">
	<head>
		<title>Patient | View Patients</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Patient | View Shop Added Medicines</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Patient</span>
...
<li class="active">
<span>View Shop Added Medicines</span>
</li>
</ol>
</div>
</section>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">View <span class="text-bold">Medicines</span></h5>
...
<td><?php echo $row['med_category'];?></td>
<td><?php echo $row['lifespancategory'];?></td>
<td><?php echo $row['manufacture_date'];?></td>
<td><?php echo $row['expiry_date'];?></td>
<td><a class='btn btn-primary btn-sky-blue' href='makeenquiry.php?uid=<?php echo $row['mediid'];?>'>Request</td>

<!-- <td>
<a href="viewmshopadddetails.php?userid=<?php echo $row['mediid'];?>"><i class="fa fa-eye"></i></a>
</td> -->
</tr>
