 ...
 if($rows['type']=="manager")
    {
     ...
     {
      $_SESSION['login_main'] = $rows['login_id'];
        header("location:medicalshop/dashboard.php");
     } 
...
$log=mysqli_query($con,"insert into patientlog(uid,username,password,status) values('".$_SESSION['pid']."','".$_SESSION['username']."','".$_SESSION['password']."','$status')");
...
<body>
  ...
  <div class="wrapper">
    ...
    <form method="POST">
      ...
      <div class="field choosetype">
      <div class="input-area">
      <label for="type">Choose Usertype</label>
