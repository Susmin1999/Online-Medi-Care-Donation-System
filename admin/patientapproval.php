...
/*--//responsive--*/
            ...
            <section class="grids-section bd-content">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Patient Requests</h4>
		...
		include '../db.php';
   		// $id= $_SESSION['ID'];
        $rs = mysqli_query($con,"SELECT * FROM login_tbl WHERE status='0' and type='patient' " );
   		while($row1=mysqli_fetch_assoc($rs))
   			{
        	$logid=$row1['login_id'];
    
        	$cs = mysqli_query($conn,"SELECT * FROM register WHERE login_id='$logid' " );
                ...
                while($row=mysqli_fetch_assoc($cs))
                {
					...
					move_uploaded_file($row['file']['tmp_name'],"../img/");
