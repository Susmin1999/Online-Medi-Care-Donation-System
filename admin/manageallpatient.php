...
if(isset($_GET['del']))
		  {
		          mysqli_query($conn,"delete from reg_tbl where reg_id = '".$_GET['id']."'");
...
<div class="visible-md visible-lg hidden-sm hidden-xs">
	...
	<a href="manageallpatient.php?id=<?php echo $row['reg_id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><button>Delete</button></a>
												</div>
