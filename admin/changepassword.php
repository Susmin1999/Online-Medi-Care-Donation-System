...
{
$sql=mysqli_query($conn,"SELECT password FROM login_tbl where password='".$_POST['cpass']."' && username='".$_SESSION['login_id']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
$con=mysqli_query($conn,"update admin set password='".$_POST['npass']."', updationDate='$currentTime' where username='".$_SESSION['login_id']."'");
...
if(isset($_POST["submit"])){
  ...
  if(mysqli_num_rows($result)>0)
  {
    ...
    if($newpassword==$confpassword)
    {
      ...
      {
      $sql1="UPDATE login_tbl set password='{$newpassword}' where login_id='{$sid}'";
