...
{
$id=$r['userid'];
$sql1="select R.*,C.id from reg_tbl R,enquiry C where  login_id=$id";
$res1=mysqli_query($conn,$sql1);

$r1=mysqli_fetch_array($res1);
?>
		<tr><td><?php echo $r1['fname'];?>
		<?php echo $r1['lname'];?><br/>
		<?php echo $r1['gender'];?><br />
		<?php echo $r1['address'];?><br/>
		<?php echo $r1['street'];?><br />
		<?php echo $r1['city'];?><br />
		<?php echo $r1['district'];?><br />
		<?php echo $r1['pin'];?><br />
		<?php echo $r1['phone'];?><br/></td>
		<td>
		<?php echo $r1['medicine_name'];?>
		<?php echo $r1['dose'];?>
		<?php echo $r1['category'];?>
		<?php echo $r1['quanitity'];?>
		<?php echo $r1['medicinecompany'];?>
	    </td>
		<td><img src="../img/<?php echo $r['idproof'];?>" width="100" height="100" /></td>
		<td><img src="../img/<?php echo $r['prescription'];?>" width="100" height="100" /></td>
		
		
        		<td><a href="approve.php?id=<?php echo $r1[9];?>&did=<?php echo $r[0]; ?>">Approve</a></td>
