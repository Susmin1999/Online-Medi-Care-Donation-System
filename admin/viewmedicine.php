...
<html lang="en">
	<head>
		<title>Admin | View Medicine</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Admin | View Medicine</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Admin</span>
...
<td><a class='btn btn-primary btn-sky-blue' href='editmedicine.php?uid=<?php echo $row['mediid'];?>'>Edit</td>
