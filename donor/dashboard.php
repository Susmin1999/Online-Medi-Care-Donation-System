					...
					<div class="wrap-content container" id="container">
						...
						<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">View Approval Status</h2>
											
											<!-- <p class="links cl-effect-1">
												<a href="mshopaddmedicine.php">
													Add Medicines
												</a>
											</p> -->
											<p class="links cl-effect-1">
												<a href="viewdonapprstatus.php">
													View Status	
												</a>
											</p>
										</div>
						...
						<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-terminal fa-stack-1x fa-inverse"></i><p></p></span>
											<h2 class="StepTitle">View Shop Added Medicines</h2>
						...
						<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-terminal fa-stack-1x fa-inverse"></i><p></p></span>
											<h2 class="StepTitle">Patient Feedback</h2>
							...
							<!-- <div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-smile-o fa-stack-1x fa-inverse"></i><p></p></span>
											<h2 class="StepTitle">Registered Patients</h2>
...
<!-- 
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-terminal fa-stack-1x fa-inverse"></i><p></p></span>
											<h2 class="StepTitle"> View Request</h2>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-terminal fa-stack-1x fa-inverse"></i><p></p></span>
											<h2 class="StepTitle"> View Medicine Request </h2>
											...
											<p class="links cl-effect-1">
												<a href="approvedmedreq.php">
												    Approved Request  
												</a>
											</p>
											<!-- <p class="links cl-effect-1">
												<a href="rejectedmedreq.php">
												    Rejected Request  
												</a>
											</p> -->
										</div>
								...
								<!-- <div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h4 class="StepTitle"> View Medicine Request</h4>									
											<p class="links cl-effect-1">
													<a href="viewmedicinerequest.php">
														Medicine Request
												</a>
											</p>
											<p class="links cl-effect-1">
													<a href="approvedmedicinereq.php">
														Approved Request
												</a>
											</p>
											<p class="links cl-effect-1">
													<a href="rejectedmedicinereq.php">
														Rejected Request
												</a>
											</p>
										</div>
